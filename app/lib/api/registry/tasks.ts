    ...
    methods: [
      {
        ...
        responseExample: {
          ...
          blocked_by: [{ id: 'uuid', title: 'string', status: 'string', assignee_id: 'uuid|null', assignee: { id: 'uuid', name: 'string' } }],
          blocking: [{ id: 'uuid', title: 'string', status: 'string', assignee_id: 'uuid|null', assignee: { id: 'uuid', name: 'string' } }],
